...
class UserDriveMapperTest(unittest.TestCase):
    ...
    def test_ping_hostname_pass(self):
        ...
        assert_that(
            ...
            equal_to([
                call(command_line='ping -c 4 -W 1000 -t 5 8.8.8.8"', quiet=True, sudo_password_override=False)
            ])
        )
    ...
    def test_ping_hostname_fail(self):
        ...
        assert_that(
            self._subject.run_command.mock_calls,
            equal_to([
                call(command_line='ping -c 4 -W 1000 -t 5 6.6.6.6"', quiet=True, sudo_password_override=False)
            ])
        )
